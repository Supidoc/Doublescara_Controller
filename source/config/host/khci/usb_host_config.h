 ...
 * transfer is the host driver resource for data transmission mission, one transmission mission need
 * one transfer.
 */
...
/*!
 * @brief host CDC RNDSI class instance count, meantime it indicates CDC rndis class enable or
 * disable.
 *        - if 0, host CDC class driver is disable.
 *        - if greater than 0, host CDC class driver is enable.
 */
