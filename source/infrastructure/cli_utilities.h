 ...
 * @brief   Utility helpers for the CLI.
 *
...
#ifndef INFRASTRUCTURE_CLI_UTILITIES_H_
#define INFRASTRUCTURE_CLI_UTILITIES_H_
...
#include "fsl_common.h"
     ...
     * parameter identifier. If the parameter is found, its value is returned. If the parameter is
     * not found, the function indicates this and returns a success status.
     *
     ...
     * @param[out] parameterFound Pointer to a variable that will be set to 1 if the parameter is
     * found, or 0 otherwise.
     * @param[out] pcParameter Pointer to a variable that will point to the first char of the
     * parameter if found.
...
#endif /* INFRASTRUCTURE_CLI_UTILITIES_H_ */
