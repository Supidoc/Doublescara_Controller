...
#define McuSSD1306_CONFIG_SSD1306_RESET_LOW()                                                      \
    Reset_ClrVal() /* RESET signal low (reset is low active) */
...
/*!< 1: Use SetDisplayOrientation() to change display orientation at runtime; 0: fixed display
 * orientation */
#endif
