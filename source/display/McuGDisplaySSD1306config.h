...
#define McuGDisplaySSD1306_CONFIG_DISPLAY_HEADER_FILE "display.h"
/*!< Header file to be included as interface to the display */
#endif
#include <display/McuSSD1306.h> /* include LCD interface */
...
/*!< 1: Share display and generate OnGetDisplay() and OnGiveDisplay() events. 0: do not share
 * display */
#endif
/* prototypes */
extern void McuGDisplaySSD1306_CONFIG_USE_DISPLAY_SHARING_OnGet(
    void); /* called at the start of display critical section */
extern void McuGDisplaySSD1306_CONFIG_USE_DISPLAY_SHARING_OnGive(
    void); /* called at the end of the display critical section */
